  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function x30(module, __webpack_exports__, __webpack_require__) {
      ...
      var TaskService = /*#__PURE__*/function () {
        function TaskService(cookieService, http) {
        ...
        _createClass(TaskService, [{
          key: "findAllTasks",
          value: function findAllTasks() {
            return this.http.get("/api/employees/".concat(this.sessionUser, "/tasks"));
          }
        }]);
      ...
      TaskService.ɵfac = function TaskService_Factory(t) {
        return new (t || TaskService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](ngx_cookie_service__WEBPACK_IMPORTED_MODULE_1__["CookieService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]));
      };
    ...
    function LmZ(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_shared_task_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var HomeComponent = /*#__PURE__*/function () {
        function HomeComponent(taskService) {
          ...
          this.taskService.findAllTasks().subscribe(function (res) {
            _this.todo = res['data'].todo;
            _this.done = res['data'].done;
            _this.doing = res['data'].doing;
          }, function (err) {
            console.log(err);
          });
        }
      ...
      HomeComponent.ɵfac = function HomeComponent_Factory(t) {
        return new (t || HomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_shared_task_service__WEBPACK_IMPORTED_MODULE_2__["TaskService"]));
      };
      ...
      HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 31,
        vars: 18,
        consts: [["fxLayout", "row wrap", "fxLayoutGap", "30px", "fxLayoutAlign", "space-evenly center", 1, "homeMainContainer"], ["fxLayout", "column", 1, "example-container"], [1, "example-card", "mat-elevation-z8"], ["mat-card-avatar", "", 1, "example-header-image"], ["cdkDropList", "", 1, "example-list", 3, "cdkDropListData", "cdkDropListConnectedTo", "cdkDropListDropped"], ["todoList", "cdkDropList"], ["class", "example-box", "cdkDrag", "", 4, "ngFor", "ngForOf"], ["doingList", "cdkDropList"], ["doneList", "cdkDropList"], ["cdkDrag", "", 1, "example-box"]],
        template: function HomeComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cdkDropListDropped", function HomeComponent_Template_div_cdkDropListDropped_8_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cdkDropListDropped", function HomeComponent_Template_div_cdkDropListDropped_18_listener($event) {
              return ctx.drop($event);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("cdkDropListDropped", function HomeComponent_Template_div_cdkDropListDropped_28_listener($event) {
              return ctx.drop($event);
            });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HomeComponent, [{
          ...
          return [{
            type: src_app_shared_task_service__WEBPACK_IMPORTED_MODULE_2__["TaskService"]
          }];
        }, null);
      })();
      /***/
        ...
        _createClass(SigninComponent, [{
          ...
          value: function login() {
            ...
            this.http.get('/api/employees/' + empId).subscribe(function (res) {
              if (res) {
                _this2.cookieService.set('session_user', empId, 1); //set the mployee id to the cookie session_user name


                _this2.router.navigate(['/']);
              } else {
                _this2.error = 'The employee ID you entered is invalid, try again.';

                _this2.openSnackBar(_this2.error);
              }
            });
          }
        }]);
